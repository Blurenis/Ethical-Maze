...
Before running any scripts, ensure that all the project dependencies are installed. In the project directory, run:

### `npm install`

This will download and install all the required dependencies and packages defined in the `package.json` file.

---

## Available Scripts

After installing the dependencies, in the project directory, you can run:
